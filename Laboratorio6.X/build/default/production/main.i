...
config_inter_eneable:
    bsf ((INTCON) and 07Fh), 7 ;Para encender las interrupciones
    bsf ((INTCON) and 07Fh), 5 ;para encender la interrupcion del timer 0
    bsf ((INTCON) and 07Fh), 6 ;para encender la interrupcion del timer 1
